    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, sb, play_button,
                ship, aliens, bullets, enemy_bullets, mouse_x, mouse_y)
            
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
        aliens, bullets, enemy_bullets, mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game_active:
        ...
        create_fleet(ai_settings, screen, ship, aliens, enemy_bullets)
        ship.center_ship()
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, enemy_bullets,
        play_button):
...
def check_bullet_ship_collisions(ai_settings, screen, stats, sb, ship, aliens,
    ...
    collisions = pygame.sprite.spritecollideany(ship, enemy_bullets)
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets, enemy_bullets):
    ...
    aliens.update(ai_settings, screen, enemy_bullets, random_number)

    # Use random number to determine which alien fires
    # random_number = random.randint(0, 99)
    # aliens.add_enemy_bullets(ai_settings, screen, enemy_bullets, random_number)
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number, enemy_bullets):
